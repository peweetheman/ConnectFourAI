...
public class minimaxAlphaBeta extends PlayerAI{
		public double minimax(Node node, double alpha, double beta){        //create tree of all moves with node at the root, alpha beta as parameters
